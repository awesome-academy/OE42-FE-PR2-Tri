...
import {
    language, ADMIN_URL, LOGIN_URL, REGISTER_URL,
    profileURL, purchaseHistoryURL
                                ...
                                isLogin ?
                                    <div className="user">
                                        ...
                                        <ul className="user__sub-menu">
                                            <li>
                                                <ArrowRightAltIcon />
                                                <Link to={profileURL(email)}>{t('profile')}</Link>
                                            </li>
                                            <li>
                                                <ArrowRightAltIcon />
                                                <Link to={purchaseHistoryURL(email)}>{t('purchase history')}</Link>
                                            </li>
                                            {
                                                roleName === 'admin' ?
                                                    <li>
